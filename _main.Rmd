...
```{r fire names list, message=FALSE, warning=FALSE}
# get list of fire names
...
```{r extract landsat2, message=FALSE, results='hide', cache=TRUE}
...
<!--chapter:end:10_NDVItrajectory_piecewise.Rmd-->
...
<!--chapter:end:11_patchfate_0to30.Rmd-->
...
<!--chapter:end:12_lei_growthwise.Rmd-->
...
```{r message=FALSE, warning=FALSE,eval=FALSE}
# map functions across all fires
...
```{r pland, message=FALSE,warning=FALSE, fig.width = 14,fig.height = 6}
...
### Percent Alike Adjacencies

```{r pladj, message=FALSE, warning=FALSE, fig.width = 14,fig.height = 6}
