# Conifer Presence-Absence Prediction
...
### Predict Presence Across 3-Year Intervals

```{r prediction function, message=FALSE,warning=FALSE}
# function to apply the RF model to predict conifer presence-absence at 3-year intervals
