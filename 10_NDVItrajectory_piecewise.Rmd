...
model_ndvi_df <- as.data.frame(do.call(rbind,map(list(seg_ndvi_df,seg_ndvi_lp,seg_ndvi_fs), coef))) %>%
  ...
  mutate(bp = c(15.713,14.708,19.247),
...
ggplot()+
  ...
  geom_line(data= data_df %>% filter(years_postfire > 0 & years_postfire<15.713),aes(x=years_postfire,y=fit),color = "#F8766D") +
  geom_line(data= data_df%>% filter(years_postfire >= 15.713),aes(x=years_postfire,y=fit),color = "#F8766D") +
  geom_line(data= data_lp %>% filter(years_postfire > 0 & years_postfire<14.708),aes(x=years_postfire,y=fit),color = "#619CFF") +
  geom_line(data= data_lp%>% filter(years_postfire >= 14.708),aes(x=years_postfire,y=fit),color = "#619CFF") +
  geom_line(data= data_fs %>% filter(years_postfire > 0 & years_postfire<19.247),aes(x=years_postfire,y=fit),color = "#00BA38") +
  geom_line(data= data_fs%>% filter(years_postfire >= 19.247),aes(x=years_postfire,y=fit),color = "#00BA38") +
