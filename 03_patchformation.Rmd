...
## Delineate High-Severity Patches
...
```{r map high severity patches}
mapview(patches_joined,col.regions = "red",layer.name = "High-severity Burn Patches") + 
  mapview(fires_export, alpha.regions = 0, lwd = 2,color = "black",col.regions = "black", layer.name = "Fire Boundaries")
```
